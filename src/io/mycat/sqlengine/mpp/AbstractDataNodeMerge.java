...
public abstract class AbstractDataNodeMerge implements Runnable{
     ...
     * 分片结束包
     */
    /* zhangyq ~ 17:07/2017-08-02 ~ 大数据产业基地亚信2楼 ~ 分片结束包 */
     ...
     * rowData缓存队列
     */
    /* zhangyq I ~ 16:58/2017-08-02 ~ 大数据产业基地亚信2楼 ~ rowData 缓存队列，由业务线程驱动合并 */
    ...
    protected final boolean addPack(final PackWraper pack){
        ...
        /* zhangyq ~ 16:57/2017-08-02 ~ 大数据产业基地亚信2楼 ~ 获取线程执行结果集合并 */
