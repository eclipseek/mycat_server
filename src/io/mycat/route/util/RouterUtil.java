...
public class RouterUtil {
	 ...
	 * @author aStoneGod
	 */
	// zhangyq | 2017/07/31/14:03 | 大数据产业基地亚信2楼 | DDL 路由策略
	// DDL 语句节点路由查找，Mycat 中对DDL 语句，如 create table 的路由规则是，现在 schema.xml 中查找
	// 表对应的规则配置，如果没有配置，在默认节点上执行。
	// 默认节点是
	//  <schema name="test" checkSQLschema="true" sqlMaxLimit="100" dataNode = "node1">
	// 中配置的 dataNode。Mycat 只允许有一个默认节点。
	// =======================================================================================
