...
public class MySQLConnection extends BackendAIOConnection {
	...
	// zhangyq | 2017/07/30/15:09 | at 江宁河定桥 STARBUCKS | 连接最后使用时间
	// 连接创建，使用时更新该时间。
	...
	// zhangyq | 2017/07/31/17:48 | 大数据产业基地亚信2楼 | 向数据库发送查询请求
	// Mycat 向后端数据库发送查询请求。
	...
	// zhangyq | 2017/07/31/17:42 | 大数据产业基地亚信2楼 | Navicate 连接 Mycat 服务，调试 use test1 时，show status 请求的调用路径。
