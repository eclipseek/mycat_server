...
public class ServerConnection extends FrontendConnection {
	...
	// zhangyq Q| 2017/07/31/17:44 | 大数据产业基地亚信2楼 | 事务隔离级别
	// 弄清楚事务隔离级别。
	...
	// zhangyq | 2017/07/30/17:22 | at 江宁河定桥 STARBUCKS | 认证超时时间
	// AUTH_TIMEOUT：发送完握手报文到收到认证报文最大 IDLE 时间。
	// 模拟 AUTH_TIMEOUT: 建立连接后不发送握手报文给客户端，服务端在
	// AUTH_TIMEOUT 之后就会将连接关闭。
	@Override
	...
	public void execute(String sql, int type) {
		...
		// zhangyq | 2017/08/01/10:13 | 大数据产业基地亚信2楼 | 根据数据库名字找到对应 SchemaConfig 配置信息。
