...
public class FrontendAuthenticator implements NIOHandler {
    ...
    protected void success(AuthPacket auth) {
        ...
        // zhangyq ~ 2017/07/30/17:32 ~ at 江宁河定桥 STARBUCKS ~ 认证完成后设置命令 handler
        // 认证成功后，将 NIOHandler 设置为 FrontendCommandHandler，
        ...
        // zhangyq ~ 2017/07/30/16:38 ~ at 江宁河定桥 STARBUCKS ~ 返回 OK 报文
        // 认证成功后向客户端发送 AUTH_OK 报文。
